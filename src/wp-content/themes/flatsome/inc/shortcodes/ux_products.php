				  ...
				  continue;
	            	...
	            	?><div class="<?php echo implode(' ', $classes_col); ?>" <?php echo $animate;?>>
						...
						<div class="product-small <?php echo implode(' ', $classes_box); ?>">
							...
							<?php 
							if ( get_field('number_sale')){
								$number_sale = get_field('number_sale');
								$width = $number_sale / 300 * 100;
								?>        					
							<div class="flashsale__bottom">
								<div class="flashsale__label">
									<img src="<?php echo get_stylesheet_directory_uri() . '/icon/fire-icon.svg' ?>"> Đã bán <b class="flashsale__sold-qty"><?php echo $number_sale;?></b> sản phẩm
								</div>
								<div class="w3-light-grey w3-round-xlarge">
									<div class="w3-blue w3-round-xlarge" style="width:<?php echo $width; ?>%"></div>
								</div>
							</div>
							<?php } ?>
						</div>
