  ...
  <?php foreach ($categories as $individual_category) : ?>
    ...
    <?php if ($my_query->have_posts()) : ?>
      ...
      <div class="related-posts row">
        ...
        <div class="row row-small large-columns-4 medium-columns-3 small-columns-1 slider row-slider slider-nav-simple slider-nav-outside slider-nav-push has-block is-draggable flickity-enabled tooltipstered" data-flickity-options='{
          "imagesLoaded": true,
          "groupCells":"100%",
          "dragThreshold": 5,
          "cellAlign": "left",
